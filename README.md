...
A project made by team BAGUETTE to change the learning method from a binary evaluative method to a demonstrative method where we would make the human pick the actions for one or more episodes and then use those as the training set.
